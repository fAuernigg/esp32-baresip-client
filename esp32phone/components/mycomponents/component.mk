#COMPONENT_SRCDIRS +=      $(COMPONENT_PATH)/../pubsubclient/src/
COMPONENT_SRCDIRS +=      ../pubsubclient/src/


# $(COMPONENT_PATH)/../ESP8266Audio/src/  $(COMPONENT_PATH)/../ESP8266_Spiram/src/

COMPONENT_ADD_INCLUDEDIRS +=  ../pubsubclient/src
COMPONENT_ADD_INCLUDEDIRS += ../baresip/include
COMPONENT_ADD_INCLUDEDIRS += ../libre/include
...
ifndef LIBRE_MK
LIBRE_MK  := $(shell [ -f $(COMPONENT_PATH)/../re/mk/re.mk ] && \
	echo "$(COMPONENT_PATH)/../libre/mk/re.mk")
ifeq ($(LIBRE_MK),)
LIBRE_MK  := $(shell [ -f $(COMPONENT_PATH)/../re-$(VERSION)/mk/re.mk ] && \
	echo "$(COMPONENT_PATH)/../re-$(VERSION)/mk/re.mk")
endif
ifeq ($(LIBRE_MK),)
...
include $(LIBRE_MK)
include $(COMPONENT_PATH)/../baresip/mk/modules.mk

ifndef LIBREM_PATH
LIBREM_PATH	:= $(shell [ -d $(COMPONENT_PATH)/../rem ] && echo "$(COMPONENT_PATH)/../rem")
endif


CFLAGS    += -I. -Iinclude -I$(LIBRE_INC) -I$(SYSROOT)/local/include -I$(SYSROOT)/include
CFLAGS    += -I$(LIBREM_PATH)/include/rem
CFLAGS    += -I$(SYSROOT)/local/include/rem -I$(SYSROOT)/include/rem

CXXFLAGS  += -I. -Iinclude -I$(LIBRE_INC)
CXXFLAGS  += -I$(LIBREM_PATH)/include/rem
...
APP_MK	:= $(COMPONENT_PATH)/../baresip/src/srcs.mk
TEST_MK	:= $(COMPONENT_PATH)/../baresip/test/srcs.mk
MOD_MK	:= $(patsubst %, $(COMPONENT_PATH)/../baresip/modules/%/module.mk,$(MODULES))
MOD_BLD	:= $(patsubst %, $(COMPONENT_PATH)/../baresip/modules/,$(MODULES))
LIBDIR     := $(PREFIX)/lib
...
Makefile:	$(COMPONENT_PATH)/../baresip/mk/*.mk $(MOD_MK) $(LIBRE_MK)
